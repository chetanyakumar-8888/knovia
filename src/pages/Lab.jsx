  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans selection:bg-purple-500/30">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-10 pb-20 relative">
        ...
        {/* Header section with Class filter */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            ...
            <p className="text-slate-400 text-lg">
              Explore {experiments.length} Interactive Practical Experiments
            </p>
          </div>
        ...
        {/* Subject Filter Area */}
        <div className="flex flex-wrap items-center justify-between border-b border-white/10 pb-6 mb-10 gap-4">
          
          <div className="flex gap-2 bg-slate-900/50 p-1.5 rounded-full border border-white/5 overflow-hidden">
          ...
          <div className="text-slate-400 font-medium text-sm px-4 py-2 bg-slate-900/50 rounded-full border border-white/5">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredExperiments.map(exp => (
            ...
            >
              {/* Background Glow matching subject */}
              ...
              <h2 className="text-xl font-bold text-slate-100 mb-2 leading-snug relative z-10">
                {exp.title}
              </h2>
              
              <p className="text-sm text-slate-400 mb-8 flex-1 relative z-10 leading-relaxed">
                {exp.desc}
              </p>
        ...
        {showComingSoon && (
          <div className="fixed bottom-10 left-1/2 -translate-x-1/2 bg-slate-900 border border-purple-500/50 shadow-[0_10px_40px_rgba(147,51,234,0.3)] rounded-full px-8 py-4 flex items-center gap-3 animate-[fade-in-up_0.3s_ease-out] z-50">
