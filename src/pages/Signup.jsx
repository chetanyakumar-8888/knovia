...
const Signup = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    password: '',
    confirmPassword: '',
    selectedClass: '10' // Default to Class 10
  });
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 selection:bg-purple-500/30">
      <div className="w-full max-w-md animate-[fade-in_0.5s_ease-out]">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 mt-2">Join the future of learning</p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="block w-full pl-11 pr-10 py-3 bg-slate-950/50 border border-white/10 rounded-xl text-white appearance-none focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all cursor-pointer"
                >
...
const GraduationCapIcon = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M21.42 10.922a2 2 0 0 0-.019-3.838L12.83 4.318a2 2 0 0 0-1.66 0L2.6 7.08a2 2 0 0 0 0 3.832l8.57 3.698a2 2 0 0 0 1.66 0z"/><path d="M22 10v6"/><path d="M6 12.5V16a6 3 0 0 0 12 0v-3.5"/></svg>
);
