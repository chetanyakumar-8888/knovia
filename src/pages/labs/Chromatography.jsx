      ...
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-gray-950/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-base sm:text-xl font-bold">Chromatography 🧫</h1>
          </div>
            ...
            <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
              ...
              <div className="mb-4">
                ...
                <div className="space-y-2">
                  {MIXTURES.map((m, i) => (
                    <button key={i} onClick={() => { setMixture(i); handleReset(); }}
                      className={`w-full text-left px-3 py-2 rounded-lg text-xs font-medium ${mixture === i ? "bg-purple-600 text-white" : "bg-gray-800 text-gray-400 hover:bg-gray-700"}`}>
                      {m.name}
                    </button>
                  ))}
                </div>
              ...
              <div className="flex gap-2">
                <button onClick={() => setRunning(!running)}
                  className={`flex-1 py-2 rounded-lg text-sm font-medium ${running ? "bg-red-600 hover:bg-red-700" : "bg-purple-600 hover:bg-purple-700"}`}>
                  {running ? "⏸ Pause" : "▶ Run"}
                </button>
