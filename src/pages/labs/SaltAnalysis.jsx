...
const SaltAnalysis = () => {
  ...
  const handleRunTest = (i) => {
    setCurrentTest(i);
    if (!completedTests.includes(i)) setCompletedTests([...completedTests, i]);
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-slate-200 pb-20">
      ...
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-gray-950/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-base sm:text-xl font-bold">Qualitative Analysis 🧪</h1>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pt-6">
              ...
              <div className="space-y-2">
                {SALTS.map((s, i) => (
                  <button key={i} onClick={() => handleSelectSalt(i)}
                    ...
                    <div className="w-10 h-10 rounded-lg shadow-inner flex items-center justify-center font-bold"
                      style={{ backgroundColor: s.color, color: '#000' }}>{s.name[0]}</div>
                    <div>
                  ...
                  <div className="relative w-20 h-40 group">
                    <div className="absolute inset-0 border-4 border-slate-700/50 rounded-b-full overflow-hidden backdrop-blur-sm">
                      <div className="absolute bottom-0 left-0 right-0 h-24 transition-all duration-700 ease-out"
                        style={{ backgroundColor: salt.color + "44" }}></div>
                    ...
                    {showFlame ? (
                      <div className="relative">
                        ...
                        <div className="absolute inset-0 blur-xl opacity-50 rounded-full"
                          style={{ backgroundColor: salt.flameTest.hex }}></div>
                      </div>
                    ) : (
        ...
        {/* Theory Footer */}
        <div className="mt-8 mb-12 bg-gray-900/50 border border-gray-800 rounded-2xl p-6">
          <h3 className="text-lg font-bold text-purple-400 mb-4">📖 Exam Theory: Systematic Analysis</h3>
          <div className="grid md:grid-cols-2 gap-8 mt-4">
            <div className="text-sm text-gray-400 space-y-2 leading-relaxed">
              <p><strong>Cation Groups:</strong> Salts are analyzed by dividing cations into groups (0 to VI) based on their solubility products.</p>
            ...
            <div className="bg-amber-500/5 border border-amber-500/20 rounded-xl p-4">
              ...
              <p className="text-sm italic">Silver Nitrate (AgNO₃) is the standard reagent for halides. AgCl is white, AgBr is pale yellow, and AgI is bright yellow.</p>
            </div>
          </div>
        </div>
