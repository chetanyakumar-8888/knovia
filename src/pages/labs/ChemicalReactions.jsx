    ...
    <div className="min-h-screen bg-gray-950 text-white p-4">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          >←</button>
          <h1 className="text-xl font-bold">Chemical Reactions ⚗️</h1>
        </div>
      ...
      <div className="flex gap-4 mb-4">
        ...
        <div className="w-1/3 flex flex-col gap-4">
          <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
            ...
            <div className="space-y-2">
              {REACTIONS.map((r, i) => (
                <button key={i}
                  onClick={() => { setSelected(i); handleReset(); }}
        ...
        {/* Right - Reaction viewer */}
        <div className="w-2/3 flex flex-col gap-4">
          {/* Equation display */}
          <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-lg font-bold" style={{ color: reaction.color }}>
            ...
            <div className="bg-gray-950 rounded-xl p-4 text-center mb-4">
              <p className="font-mono text-lg" style={{ color: reaction.color }}>
                {reaction.equation}
              </p>
            </div>
